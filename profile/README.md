...
The ARC Training Centre in Data Analytics for Resources and Environments (DARE)
developed novel data science in the domains of water, minerals and biodiversity,
to drive integrated decisions in the management of Australia's natural
resources. DARE was funded by the Australian Government and industry partners
through the Australian Research Council Industrial Transformation Research
Program.

Selected digital resources by DARE members and collaborators are collated here.
...
- [DARE Data Challenge: Internal](https://github.com/dare-centre/data-challenge-internal) | Python, R: Resources for the DARE internal deluxe data challenge.
...
- [Gaussian Combiner](https://github.com/dare-centre/gaussian-combiner) | MATLAB: Combining multiple univariate Gaussians into one multivariate Gaussian.
